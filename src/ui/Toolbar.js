...
export class Toolbar {
  ...
  render() {
    ...
    const tools = [
      ...
      { id: 'triangle', icon: 'change_history', tooltip: 'Triangle' },
      { id: 'diamond', icon: 'diamond', tooltip: 'Diamond' },
      { id: 'star', icon: 'star_outline', tooltip: 'Star' },
      { id: 'polygon', icon: 'hexagon', tooltip: 'Polygon' },
